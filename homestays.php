...
<head>
	<? write_page_info('Find out about our Home-stay accommodation options','Home-stay Accommodation');?>
	<? write_css(ST_BASIC); ?>
		...
		<div class="colmask rightmenu">
			<div class="colleft">
				<div class="col1wrap">
					<div class="col1">
						<!-- Column 1 start -->
						<h1><img src="img/logos/lets_go_volunteer.gif" alt="Let's Go Volunteer"/>Homestay Accommodation</h1>
						<hr/>
						<p><img src="img/inline/" class="left"/></p>
						<p><img src="img/inline/" class="right"/></p>
						<!-- Column 1 end -->
					</div>
				</div>
				<div class="col2">
